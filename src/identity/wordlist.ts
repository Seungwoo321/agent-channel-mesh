/**
 * PGP 워드 리스트 (biometric word list)
 *
 * 출처: Philip Zimmermann, https://philzimmermann.com/docs/PGP_word_list.pdf
 * 설계: Patrick Juola · Philip Zimmermann (1995), 개선 Jon Callas
 *
 * 각 바이트 값을 두 단어로 표현한다 — 짝수 오프셋은 EVEN(2음절),
 * 홀수 오프셋은 ODD(3음절). 교대 구조가 전치·중복·누락을 검출한다.
 *
 * 이 파일은 손으로 수정하지 않는다. 정본 표에서 파싱해 생성했고
 * test/wordlist.test.ts 의 정본 벡터로 검증된다.
 */

/** 짝수 오프셋 — 2음절, 최대 9글자 */
export const EVEN: readonly string[] = [
...
/** 홀수 오프셋 — 3음절, 최대 11글자 */
export const ODD: readonly string[] = [
