...
import type { MeshNode, Dropped } from '../node/node.ts'
import { Inbox } from './inbox.ts'
import { callTool, SEND_TOOL, CHANNELS_TOOL, INBOX_TOOL, type ToolSpec } from './tools.ts'
import { ClaudeAdapter, CAPABILITIES, INSTRUCTIONS } from './claude.ts'
